...
public class BaseServlet extends HttpServlet {
	...
	public void writeValue(Object object, HttpServletResponse resp) throws  Exception{
		ObjectMapper objectMapper = new ObjectMapper();
		resp.setContentType("application/json;charset=utf-8");
		objectMapper.writeValue(resp.getOutputStream(),object);
	}

	public String writeValueAsString(Object object, HttpServletResponse resp)throws  Exception{
		ObjectMapper objectMapper = new ObjectMapper();
